...
SEASON_AWARDS_2025_26: list[Headline] = [
    # MVP is the only confirmed award as of the demo date (2026-05-17).
    # Every other "award" the league has not yet announced reads as a
    # poll-leading watch card so the demo never fabricates a result.
    Headline(
    ...
    Headline(
        kind="player", category="awards",
        label="CLUTCH POY · LEADING THE POLLS",
        primary="Shai Gilgeous-Alexander",
        secondary="OKC · vote not yet announced",
        metric="CPOY watch",
        tone="violet", team_abbr="OKC",
    ),
    Headline(
        kind="player", category="awards",
        label="DEFENSIVE PLAYER OF THE YEAR · LEADING THE POLLS",
        primary="Victor Wembanyama",
        secondary="SAS · 4.10 BPG playoffs · vote not yet announced",
        metric="DPOY watch",
        tone="ice", team_abbr="SAS",
    ),
    Headline(
        kind="player", category="awards",
        label="MOST IMPROVED PLAYER · LEADING THE POLLS",
        primary="Cade Cunningham",
        secondary="DET · 29.3 playoff PPG · vote not yet announced",
        metric="MIP watch",
        tone="ember", team_abbr="DET",
    ),
    Headline(
        kind="team", category="awards",
        label="COACH OF THE YEAR · LEADING THE POLLS",
        primary="Mark Daigneault",
        secondary="OKC · 8-0 through Round 2 · vote not yet announced",
        metric="COTY watch",
        tone="emerald", team_abbr="OKC",
    ),
    Headline(
        kind="player", category="awards",
        label="SIXTH MAN OF THE YEAR · LEADING THE POLLS",
        primary="Payton Pritchard",
        secondary="BOS · best bench offense in the league · vote not yet announced",
        metric="6MOY watch",
        tone="rose", team_abbr="BOS",
    ),
    Headline(
        kind="player", category="awards",
        label="ROOKIE OF THE YEAR · LEADING THE POLLS",
        primary="Cooper Flagg",
        secondary="DAL · No. 1 pick in 2025 · vote not yet announced",
        metric="ROY watch",
        tone="ice", team_abbr="DAL",
    ),
    Headline(
        kind="team", category="awards",
        label="ALL-NBA · PROJECTED FIRST TEAM",
        primary="SGA · Jokić · Wembanyama · Brunson · Cunningham",
        secondary="Consensus front-runners pre-Finals",
        metric="All-NBA 1st (proj.)",
